"Central IoT - Arduino Day SP 2016"
...
TopicoSubscriber = "ArduinoDay2016SPEnvia"   #topico usado para receber dados do websocket 
TopicoPublisher = "ArduinoDay2016SPRecebe"  #topico usado para enviar dados do websocket
...
ChavePublica = "ARDUINODAYSP2016"   #Chave publica usada na encriptacao. Deve ser conhecida pelo client que fara a decriptacao
...
def InicializaDisplay():
	...
	lcdDisplay.write("Arduino Day SP ")
	
	lcdDisplay.setCursor(1, 0)
	lcdDisplay.write("      2016     ")
...
while True:
	...
	if (StatusConexaoBroker > 0):
		client.connect("iot.eclipse.org", 1883, 60)  #se ocorrer algum erro, reconecta-se ao broker
